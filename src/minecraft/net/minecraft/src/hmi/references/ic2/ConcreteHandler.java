...
public class ConcreteHandler extends TabHandler {
	...
	public void loadTabs(BaseMod basemod) {
		...
		mod_HowManyItems.addGuiToBlock(net.minecraft.src.ic2.GuiIronFurnace.class, new ItemStack(Block.stoneOvenIdle));
		
		mod_HowManyItems.addEquivalentFurnace(new ItemStack(machine, 1, 2));
		mod_HowManyItems.addGuiToBlock(net.minecraft.src.ic2.GuiElecFurnace.class, new ItemStack(Block.stoneOvenIdle));
		
		mod_HowManyItems.addEquivalentFurnace(new ItemStack(machine, 1, 13));
		mod_HowManyItems.addGuiToBlock(net.minecraft.src.ic2.GuiInduction.class, new ItemStack(Block.stoneOvenIdle));
		...
		mod_HowManyItems.addGuiToBlock(net.minecraft.src.ic2.GuiMacerator.class, new ItemStack(machine, 1, 3));
		...
		mod_HowManyItems.addGuiToBlock(net.minecraft.src.ic2.GuiCompressor.class, new ItemStack(machine, 1, 5));

		mod_HowManyItems.addTab(new TabSmelting(basemod, TileEntityExtractor.recipes, fuels, "/IC2sprites/GUIExtractor.png", machine, 4));
		mod_HowManyItems.addGuiToBlock(net.minecraft.src.ic2.GuiExtractor.class, new ItemStack(machine, 1, 4));
		
		mod_HowManyItems.addTab(new TabIC2CanningMachine(basemod, fuels, "/IC2sprites/GUICanner.png", machine, 6));
		mod_HowManyItems.addGuiToBlock(net.minecraft.src.ic2.GuiCanner.class, new ItemStack(machine, 1, 6));
		
		mod_HowManyItems.addTab(new TabIC2Recycler(basemod, fuels, "/IC2sprites/GUIRecycler.png", machine, 11));
		mod_HowManyItems.addGuiToBlock(net.minecraft.src.ic2.GuiRecycler.class, new ItemStack(machine, 1, 11));
