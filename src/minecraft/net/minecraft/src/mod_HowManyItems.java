    ...
    public static ArrayList<TabRecipeViewer> getTabs() {
    	if(tabs == null) {
    		...
    		if(ModLoader.isModLoaded("mod_IndustrialCraft")) {
    			...
    			try {
    				allTabs.add(new TabRecipeViewerFurnace(thisMod, (Map)ModLoader.getPrivateValue(MaceratorRecipes.class, MaceratorRecipes.smelting(), "smeltingList"), fuels, "/IndustrialSprites/MaceratorGUI.png", mod_IndustrialCraft.blockMaceratorOff));
    				allTabs.add(new TabRecipeViewerFurnace(thisMod, (Map)ModLoader.getPrivateValue(ExtractorRecipes.class, ExtractorRecipes.smelting(), "smeltingList"), fuels, "/IndustrialSprites/ExtractorGUI.png", mod_IndustrialCraft.blockExtractorOff));
    				allTabs.add(new TabRecipeViewerFurnace(thisMod, (Map)ModLoader.getPrivateValue(CompressorRecipes.class, CompressorRecipes.smelting(), "smeltingList"), fuels, "/IndustrialSprites/CompressorGUI.png", mod_IndustrialCraft.blockCompressorOff));
    			} 
